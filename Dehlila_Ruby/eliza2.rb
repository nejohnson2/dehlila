  ...
  ELIZA_RULES2 = ELIZA_RULES + 
    [
     ...
     Rule.new(Pattern.new(%w(*x you are *y)),
     		  "Do you really think I am ?y",
     		  "I think you are ?y",
     		  "Let's focus on you, and not on the fact I am ?y.",
     ...
     Rule.new(Pattern.new(%w(*x you are *y)),
     		  "Do you really think I am ?y",
     		  "I think you are ?y"),
     Rule.new(Pattern.new(%w(*x I'm *y)),
     		  "Why are you ?y",
     		  "Do you like being ?y?",
     ...
     Rule.new(Pattern.new(%w(*x I want *y)),
     		  "Do you want ?y often?",
     		  "Why do you want ?y?"),
     Rule.new(Pattern.new(%w(*x why *y)),
     		  "Why do you think?",
     		  "Why not?",
     		  "Will you answer?",
     		  "Why do you want ?y?"),     		  
     Rule.new(Pattern.new(%w(*x)),
              ...
              "Does it bother you that I asked that?",
              "I am not sure I understand you fully.  Can you explain further?",
              "Can you elaborate on that?",
              "What does that suggest to you?",
              "Please continue.  This seems important",
